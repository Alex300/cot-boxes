...
$L['cfg_box_speedup'] = 'CONNECTING CSS FILES<br>specify the file name and extension in the folder css, situated <b>' . Cot::$cfg['mainurl'] . '/' . Cot::$cfg['themes_dir'] . '/' . $theme . '/css/' .
...
$L['cfg_box_speedupjs'] = 'AREA paste content JS FILE<br>specify the file name and extension in the folder js, situated <b>' . Cot::$cfg['mainurl'] . '/' . Cot::$cfg['themes_dir'] . '/' . $theme .
