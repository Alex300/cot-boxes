...
$L['cfg_box_speedup'] = 'ПОДКЛЮЧЕНИЕ CSS ФАЙЛОВ<br>укажите названия файлов и их расширение из папки css, расположенной <b>' . Cot::$cfg['mainurl'] . '/' . Cot::$cfg['themes_dir'] . '/' . $theme .
...
$L['cfg_box_speedupjs'] = 'ПОЛЕ ДЛЯ ВСТАВКИ СОДЕРЖИМОГО JS ФАЙЛОВ<br>Укажите названия файлов и их расширение из папки js, расположенной <b>' . Cot::$cfg['mainurl'] . '/' . Cot::$cfg['themes_dir'] .
